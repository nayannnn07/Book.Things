...
// Author : Samir Khanal
$error_message = "";
$khalti_public_key = "test_public_key_6b6a8c6d85564ddf9fc487b2d383b7cb";
...
$successRedirect = "http://localhost/BookStore/user/userHome.php"; // change this url , it will be the page user will be redirected after successful payment
